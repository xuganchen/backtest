    ...
    def generate_signals(self, event):
        if event.type == EventType.MARKET:
            ...
            if (bars_MACD is not None and bars_MACD != []) and (bars_BOLL is not None and bars_BOLL != []):
                ...
                elif short_ma < long_ma and event.close < lowerbound and self.holdinds[ticker] == "HOLD":
...
if __name__ == "__main__":
    ...
    backtest, results = run_backtest(config, trading_data, ohlc_data, short_window = 4, long_window = 81, window = 11, a = 3)
