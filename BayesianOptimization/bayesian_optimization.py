...
class BayesianOptimization(object):
    ...
    def __init__(self, target_func, pbounds, is_int, 
        ...
        self.space = TargetSpace(target_func, pbounds, is_int, 
                                invariant = invariant, random_state = random_state)
        self.is_int = is_int
    ...
    def initialize_points(self, init_points):
        """
    ...
    def maximize(self,
        ...
        if not self.initialized:
            ...
            self.initialize_points(init_points)
