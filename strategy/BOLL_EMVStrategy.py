...
if __name__ == "__main__":
    ...
    for ticker in config['tickers']:
        ...
        ohlc_data[ticker] = pd.read_hdf(config['csv_dir'] + '\\' + ticker +'_OHLC_1min.h5', key=ticker)

    trading_data = None

    backtest, results = run_backtest(config, trading_data, ohlc_data, window_BOLL = 65, a = 0.243, window_EMV=33, n=115, m=17)
