...
def running(X):
    config = {
        ...
        "out_dir": os.path.join(back_config['output_folder'], "WMAStrategy"),
        "title": "WMAStrategy",
        "is_plot": False,
        "save_plot": True,
        "save_tradelog": True,
    ...
    index = 'WMA'
    return run_backtest(config, trading_data, ohlc_data, index, short_window, long_window)
