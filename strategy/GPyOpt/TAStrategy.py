...
if __name__ == "__main__":
    config = {
        ...
        "out_dir": os.path.join(back_config['output_folder'], "EMAStrategy"),
        "title": "EMAStrategy",
        "is_plot": False,
        "save_plot": True,
        "save_tradelog": True,
    ...
    backtest, results = run_backtest(config, trading_data, ohlc_data, index = 'EMA', short_window = 3, long_window = 57)
