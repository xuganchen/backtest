...
if __name__ == "__main__":
    config = {
        ...
        "out_dir": os.path.join(back_config['output_folder'], "MACDCrossStrategy"),
        "title": "CCIStrategy",
        "is_plot": False,
        "save_plot": True,
        "save_tradelog": True,
    ...
    backtest, results = run_backtest(config, trading_data, ohlc_data, short_window=114, long_window=166)
