...
if __name__ == "__main__":
    config = {
        ...
        "out_dir": os.path.join(back_config['output_folder'], "ADX_RSIStrategy"),
    ...
    backtest, results = run_backtest(config, trading_data, ohlc_data, window_ADX = 16, window_RSI = 51, s=84, b=44)
